  ...
  <div id="header" class="home">
    ...
    <div class="container">
      <div class="header-content">
        <h1>Welcome to <!--  <span class="typed">Ramrouma tahfouna  </span>--> 
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 ">
          <div class="div-img-bg">
            <div class="about-img">
              <img src="images/buy2.jpg" class="img-responsive" alt="buy">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-7">
          <div class="about-descr">
            ...
            <p class="p-heading">We are here to help you find your new car. </p>
            <p class="separator">You will find here everthing you are looking for.</p>
    ...
    <div class="container">
        ...
        <div class="services-carousel owl-theme">
          ...
          <div class="services-block">
            ...
            <span>USED CARS</span>
            <p class="separator">We are here to help you find the best quality/price in the mar</p>
          ...
          <div class="services-block">
            ...
            <i class="ion-ios-pricetag-outline"></i>
            <span>NEW CARS</span>
            <p class="separator">New cars ? mel bakou ,yes you'll find them here. </p>
          ...
          <div class="services-block">
            ...
            <p class="separator">We can estimate for you how much your car costs. </p>
          ...
          <div class="services-block">
            ...
            <i class="ion-ios-pricetag-outline"></i>
            <span>CAR NEWS</span>
            <p class="separator">You'll find here the latest news in cars world.</p>
  ...
  <div id="journal" class="text-left paddsection">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2> <a href="news.php" > Get the latest news </a></h2>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="journal-info">
              ...
              <img src="images/aston-martin.jpg" class="img-responsive" alt="img"></a>

              <div class="journal-txt">

                <h4>Aston Martion Rapide E</a></h4>
                <p class="separator"> .</p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="journal-info">
              ...
              <img src="images/TeslaRoadster.jpg" class="img-responsive" alt="img"></a>

              <div class="journal-txt">

                <h4>Tesla Roadster</a></h4>
                <p class="separator">.
                </p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="journal-info">
              ...
              <img src="images/citroen.jpg" class="img-responsive" alt="img"></a>

              <div class="journal-txt">

                <h4><a href="blog-single.html">Citroen C4 EV</a></h4>
                <p class="separator">.
                </p>
