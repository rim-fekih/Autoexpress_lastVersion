...
<h3><font   face="Comic Sans MS">Ajouter Admin</font></h3>

<div>
 <form action="addadmin.php" method="post" enctype="multipart/form-data" name="admin" >
    ...
    <label><font   face="Comic Sans MS"  >Droit:</font></label>
    ...
    <input type="submit" name="submit" value= "Ajouter Admin">
    <input type="button" onclick="window.location.replace('Admins.php')" value="Annuler" />
  </form>
