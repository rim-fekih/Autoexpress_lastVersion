<?php
                    ...
                    $sql = "SELECT ID,TITLE_fr,DESCRIPTION_fr,BODY_fr,IMG1 FROM articles where type='Vision' ";
            ...
            echo'<tr>
              <td class="mailbox-star"></td>
                          ...
                          <td class="mailbox-star" width="800"><strong>Corps</strong></td>
              ...
              <td class="mailbox-star"></td>
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "  <tr>
                                        ...
                                        <div class=\"btn-group\">
                                        <a href=\"modification/Vision.php?idVi=$idVi&titre=$titre&desc=$desc&image=$img\">
                                        <button type=\"button\" class=\"btn btn-default btn-sm\"><i class=\"fa fa-gears\"></i></button></a>
                                        <a href=\"suppression/Vision.php?idVi=$idVi\">
