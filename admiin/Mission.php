      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="font-size: 12px;">
            ...
            <li> <a href="Clients"> Gestion Utilisateurs </a></li>
            <li> <a href="Service et Solution.php "> Gestion Service et Solution </a></li>
            <li> <a href="Actualite.php"> Gestion Actualités </a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border" style="text-align: center;">
              <h3 class="box-title">Gestion Mission</h3>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                <a href="ajoutmission.php"><button type="button" class="btn btn-default btn-sm checkbox-toggle"><i class="fa fa-plus"></i>
                </button></a>
                <div class="btn-group">
                  <b>Ajouter Mission</b>
                </div>
              </div>
               <!-- <a href="eventsPics.php"><button type="button" class="btn btn-default btn-sm checkbox-toggle"><i class="fa fa-plus"></i>
                </button></a>
                <div class="btn-group">
                  <b>Add pictures      </b>
                </div>
