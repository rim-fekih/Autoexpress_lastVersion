...
?>
<div>
 <form action="modifypartner.php" method="POST" enctype="multipart/form-data" name="service">
 ...
 <label><font   face="Comic Sans MS"  >Body</font></label>
   ...
   <label><font   face="Comic Sans MS" >Ajouter l'image à inserer</font> </label>
    ...
    <input type="button" onclick="window.location.replace('../Parteniare.php')" value="Annuler" />
  </form>
</div>
