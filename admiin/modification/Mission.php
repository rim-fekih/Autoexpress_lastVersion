...
<h3>Modification Mission</h3>
<?php session_start();
$_SESSION['idMs']=$_GET['idMs']; 
$titre=$_GET['titre'];
$desc=$_GET['desc'];
$image=$_GET['image'];
...
?>
<div>
  <form action="ModificationMission.php" method="POST" enctype="multipart/form-data">
    <label>Titre</label>
    ...
    <input type="button" onclick="window.location.replace('../Mission.php')" value="Annuler" />
  </form>
</div>
