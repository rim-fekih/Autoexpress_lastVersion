...
<h3>Modification Valeur</h3>
<?php session_start();
$_SESSION['idVal']=$_GET['idVal']; 
$titre=$_GET['titre'];
$desc=$_GET['desc'];
$image=$_GET['image'];
...
?>
<div>
  <form action="ModificationValeur.php" method="POST" enctype="multipart/form-data" >
    <label>Titre</label>
    ...
    <input type="button" onclick="window.location.replace('../Valeur.php')" value="Annuler" />
  </form>
</div>
