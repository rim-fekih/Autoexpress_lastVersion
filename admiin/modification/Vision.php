...
<h3>Modification Vision</h3>
<?php session_start();
$_SESSION['idVi']=$_GET['idVi']; 
$titre=$_GET['titre'];
$desc=$_GET['desc'];
$image=$_GET['image'];
...
?>
<div>
  <form action="ModificationVision.php" method="POST" enctype="multipart/form-data">
    <label>Titre</label>
    ...
    <input type="button" onclick="window.location.replace('../Vision.php')" value="Annuler" />
  </form>
</div>
