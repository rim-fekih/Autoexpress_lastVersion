                    ...
                    $sql = "SELECT ID,TITLE_fr,DESCRIPTION_fr,BODY_fr,IMG1 FROM articles where type='About' ";
              ...
              <td class="mailbox-star"></td>
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "  <tr>
                                        ...
                                        <div class=\"btn-group\">
                                        <a href=\"modification/About.php?idAb=$idAb&titre=$titre&desc=$desc&image=$img\">
                                        <button type=\"button\" class=\"btn btn-default btn-sm\"><i class=\"fa fa-gears\"></i></button></a>
                                        <a href=\"suppression/About.php?idAb=$idAb\">
