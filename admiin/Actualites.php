        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border" style="text-align: center;">
              <h3 class="box-title">Gestion Actualités</h3>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                <a href="AjoutActualites.php"><button type="button" class="btn btn-default btn-sm checkbox-toggle"><i class="fa fa-plus"></i>
                </button></a>
                <div class="btn-group">
                  <b>Ajouter Actualité</b>
                </div>
              </div>
