      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="font-size: 12px;">
            ...
            <li> <a href="#"> Gestion Actualités </a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border" style="text-align: center;">
              <h3 class="box-title">Gestion Administrateur</h3>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                <a href="AjoutAdmin.php"><button type="button" class="btn btn-default btn-sm checkbox-toggle"><i class="fa fa-plus"></i>
                </button></a>
                <div class="btn-group">
                  <b>Ajouter Admin</b>
                </div>
