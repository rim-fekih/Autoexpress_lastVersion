...
<h3><font   face="Comic Sans MS">Ajouter Reference</font></h3>

<div>
 <form action="addreference.php" method="post" enctype="multipart/form-data" name="service" >
    <label><font   face="Comic Sans MS"  >ID</font></label>
    <input type="number" name="id" id="id"  placeholder="ID..">
    <label><font   face="Comic Sans MS"  >Nom Reference</font></label>
    ...
    <input type="submit" name="submit" value= "Ajouter Reference">
    <input type="button" onclick="window.location.replace('Reference.php')" value="Annuler" />
  </form>
