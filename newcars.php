...
<head>
  ...
  <link href="css/newcars-style.css" rel="stylesheet">
  ...
  <div id="header" class="home">
    ...
    <div class="container">
      <div class="header-content">
        <h1>New Cars <span class=""></span></h1>
        <p>AutoExpress</p>
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-7">
          <div class="about-descr">
            ...
            <p class="p-heading">Find out about new cars and its prices </p>
            <p class="separator">You will find here everthing you are looking for.</p>
            <!-- houni bech yjiw akaa modele marque wel prix -->
            <div class="try">
               <?php
                include'Try1.php';
                ?>
